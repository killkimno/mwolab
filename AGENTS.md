...
- If neither an exact same-name match nor a recorded resolution exists, report the unresolved mech variant and component and ask the user which mech variant or omnipod set it should use. Do not choose by majority, loadout dominance, alphabetical order, or another heuristic.
